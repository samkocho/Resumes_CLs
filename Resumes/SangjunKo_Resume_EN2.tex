...
\setlist{nolistsep}
    ...
    \begin{itemize}[noitemsep]
        ...
        \item Developed predictive machine learning models with large data sets(100,000+ entries) using Python
        \item Utilized advanced techniques: XGBoost, Random Forests, Regression, Neural Networks, BERT, Transformers
        \item Collaborated closely with 3 coordinators in weekly meetings to align project goals and track progress
    \end{itemize}
