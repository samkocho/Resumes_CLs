...
\setlist{nolistsep}
    \begin{itemize}[noitemsep]
        \item Grade assignments and provide feedback to help 20+ students improve statistical analysis and consulting skills
...
\setlist{nolistsep}
    ...
    \begin{itemize}[noitemsep]
        ...
        \item Led outreach and interviews with target demographics to gather insights on pelvic floor health        \item Synthesized findings into actionable strategies and presented recommendations to stakeholders   \end{itemize}
